...
def process(user,tweet,word,author,topic,hp,shp_off,rte_off,BTM,length):
    ...
    #THETA_RTE,BETA_RTE=BTM_initialize()
    #phi_s1 = dok_matrix((user*author*tweet,topic),dtype=np.float64)
    #phi_s2 = dok_matrix((user*author*tweet,topic),dtype=np.float64)
    #phi_z = dok_matrix((word*tweet,topic),dtype=np.float64)
    ...
    while 1:
        ...
        if iter%1==0:
            ...
            #X_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP_TEMP,U_RTE_TEMP,Y_SHP_TEMP,Y_RTE_TEMP,V_SHP_TEMP,V_RTE_TEMP,THETA_SHP_TEMP,THETA_RTE_TEMP,BETA_SHP_TEMP,BETA_RTE_TEMP,THETA_RTE_HP,BETA_RTE_HP)
            #U_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP,U_RTE,Y_SHP_TEMP,Y_RTE_TEMP,V_SHP_TEMP,V_RTE_TEMP,THETA_SHP_TEMP,THETA_RTE_TEMP,BETA_SHP_TEMP,BETA_RTE_TEMP,THETA_RTE_HP,BETA_RTE_HP)
            #Y_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP,U_RTE,Y_SHP,Y_RTE,V_SHP_TEMP,V_RTE_TEMP,THETA_SHP_TEMP,THETA_RTE_TEMP,BETA_SHP_TEMP,BETA_RTE_TEMP,THETA_RTE_HP,BETA_RTE_HP)
            #V_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP,U_RTE,Y_SHP,Y_RTE,V_SHP,V_RTE,THETA_SHP,THETA_RTE,BETA_SHP,BETA_RTE,THETA_RTE_HP,BETA_RTE_HP)
            #TH_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP,U_RTE,Y_SHP,Y_RTE,V_SHP,V_RTE,THETA_SHP,THETA_RTE,BETA_SHP_TEMP,BETA_RTE_TEMP,THETA_RTE_HP,BETA_RTE_HP)
            #BE_elbo=elbo+ELBO(hp,X_SHP,X_RTE,U_SHP,U_RTE,Y_SHP,Y_RTE,V_SHP,V_RTE,THETA_SHP,THETA_RTE,BETA_SHP,BETA_RTE,THETA_RTE_HP,BETA_RTE_HP)
            ...
            print 'elbo is  '+str(elbo)
            #
            #print 'U_elbo is  '+str(U_elbo)
            #print 'Y_elbo is  '+str(Y_elbo)
            #print 'V_elbo is  '+str(V_elbo)
            #print 'TH_elbo is  '+str(TH_elbo)
            #print 'BE_elbo is  '+str(BE_elbo)
